...
if (isset($_POST['publish'])) {
    ...
    $insert_message = $conn->prepare("INSERT INTO `message_étudiant_env_groups` (étudiant_id, content, formation_id) VALUES (?,?,?)");
...
<?php
      ...
      <div class="pdf">
            ...
            <a href="login_cours.php?cours_id=<?= $fetch_posts['id']; ?>"> <?= $fetch_posts['title_cours']; ?> 
...
<?php
    ...
    <section class="post-editor" dir="rtl">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="flex-btn">
                <input type="submit" value="envoyer" name="publish" class="btn">
            </div>
        </form>
