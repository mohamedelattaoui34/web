        ...
        <div class="table-cont">
          ...
          <table>
            <thead>
              ...
              <th> titre</th>
                 <th> Cas de cours</th>
                 <th> Téléchargez la cours</th>
                 <th>avoir les chapitres</th>
            ...
            <?php
         $select_partie = $conn->prepare("SELECT * FROM `partie` WHERE cours_id = ? and status = ?");
         $select_partie->execute([$cours_id, 'active']);
            ...
            <tbody>
              <tr>
                ...
                <?php if ($fetch_partie['pdf'] != '') { ?>
                        ...
                        <td>
                <a href="view_chapter.php?cours_id=<?= $cours_id; ?>&partie_id=<?= $partie_id; ?>"><i class="fa-solid fa-eye"></i></a>
