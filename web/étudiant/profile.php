    ...
    <div class="Container">
        ...
        <?php
         ...
         ?>
                ...
                <a href="edit_photo.php?étudiant_id=<?= $étudiant_id; ?>"><i class="fa-solid fa-camera"></i></a>
