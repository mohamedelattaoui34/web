...
if (isset($_POST['publish'])) {
    ...
    $insert_message = $conn->prepare("INSERT INTO `message_étudiant_env` (étudiant_id, content, Enseignants_id) VALUES (?,?,?)");
    $insert_message->execute([$étudiant_id, $content, $get_id]);
}
...
$select_messages->execute([$get_id, $étudiant_id, $get_id, $étudiant_id]);
