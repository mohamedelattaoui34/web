      ...
      <div class="main">
        ...
        <div class="table-cont">
          ...
          <table>
            ...
            <?php
                  $select_étudiant = $conn->prepare("SELECT * FROM `groups` WHERE étudiant_id = ? ORDER BY id DESC");
                  $select_étudiant->execute([$get_id]);
            ...
            <tbody>
              <tr>
                ...
                <?php
                  ...
                  $select_formation->execute([$fetch_étudiant['Enseignants_id']]);
...
<td>
                            ...
                            <input type="hidden" name="group_id" value="<?= $fetch_étudiant['id']; ?>">
                            <button type="submit" class="inline-delete-btn" name="delete_groups" onclick="return confirm('Voulez-vous supprimer');"><i class="fa-solid fa-trash"></i></button>
                            </form>
                        </td>
