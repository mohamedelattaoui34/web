...
if(isset($_POST['submit'])){
    ...
    $insert_user = $conn->prepare("UPDATE `admine` SET image = ? WHERE id = ?");
    $insert_user->execute([$image, $admin_id]);
        ...
        <div class="user-details">
            ...
            <div class="kiki">
                <label for="image-input" class="file-upload">
                    ...
                    <p class="det">Choisir une image</p>
...
<script>
    ...
    fileInput.addEventListener("change", function() {
        ...
        if (file) {
            ...
            reader.onload = function(event) {
                ...
                deleteOverlay.style.display = "block"; // Afficher l'icône de suppression lorsque une image est sélectionnée
            };
    ...
    deleteOverlay.addEventListener("click", function() {
        imagePreview.src = ""; // Effacer l'aperçu de l'image
        fileInput.value = ""; // Effacer la valeur du champ de fichier
        deleteOverlay.style.display = "none"; // Masquer l'icône de suppression
    });
</script>
