      ...
      <div class="main">
        ...
        <div class="table-cont">
          ...
          <table>
            ...
            <?php
                  $select_groups = $conn->prepare("SELECT * FROM `groups` WHERE formation_id = ? AND Enseignants_id = ? ORDER BY id DESC");
                  $select_groups->execute([$get_id, $Enseignants_id]);
              ...
              <tr>
                ...
                <?php
                  ...
                  if($select_formation->rowCount() > 0){
                    $fetch_formation = $select_author->fetch(PDO::FETCH_ASSOC)

                  ?>
                  <p><?= $select_formation['title']; ?></p>
...
<td>
                            ...
                            <button type="submit" class="inline-delete-btn" name="delete_comment" onclick="return confirm(' Voulez-vous vraiment supprimer ? ');"><i class="fa-solid fa-trash"></i></button>
                            </form>
                        </td>
